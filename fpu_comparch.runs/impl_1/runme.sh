...
HD_PWD='D:/Rohit BITS Data/3_Third Year/Second Sem/Comp Arch/Vivado/fpu_comparch/fpu_comparch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpu_wrapper.tcl -notrace

...
HD_PWD='D:/Rohit BITS Data/3_Third Year/Second Sem/Comp Arch/Vivado/fpu_comparch/fpu_comparch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpu_wrapper.tcl
